...
- Body, které se nepodaří v terénu dohledat, se do mapy zanesou s klíčem ***removed:highway=emergency_access_point***, takto označené body budou nasledně zapsány do souboru [BZneni.csv](BZneni.csv). 
